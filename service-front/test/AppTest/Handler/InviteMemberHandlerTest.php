...
class InviteMemberHandlerTest extends TestCase
{
    ...
    public function testPostWithExistingInviteResourceUpdatesFormErrorMessage(string $errorCode, string $expectedMessage): void
    {
        ...
        $this->sharedSpaceService
            ->method('invite')
            ->willThrowException(new ApiException(new Response($errorCode, StatusCodeInterface::STATUS_UNPROCESSABLE_ENTITY), $errorCode));
    ...
    public function testPostWithUnexpectedErrorSetsErrorInRender(): void
    {
        ...
        $this->sharedSpaceService
            ->method('invite')
            ->willThrowException(new ApiException(new Response('some-error', StatusCodeInterface::STATUS_UNPROCESSABLE_ENTITY), 'some-error'));
